...
const dict: Dict = {
  ...
  "about.desc": {
    ...
    en: "Rural Social Industrial Complex (RSIC): is a pioneering national initiative for comprehensive industrial transformation through integrated complexes across states and localities, turning local resources into high-value products",
  },
  ...
  "about.vision.body": {
    ...
    en: "“A prosperous Sudan, built on a resilient, compassionate, responsible, and sustainable industrial economy led by local communities through knowledge, solidarity, and creativity\u00a0\nanchored in virtuous ethics and a love of doing good”",
  },
  ...
  "about.mission.body": {
    ...
    en: "“Empowering Sudanese communities to build and operate Rural Social Industrial Complexes (RSICs) that use and develop local resources with efficiency and globally competitive excellence\u00a0\nachieving food security and self-sufficiency, creating real and high-quality jobs, and restoring trust between citizen and state through a fair, transparent, and sustainable economic model”",
  },
